 ...
 *
 * $Id: hndctf.h,v 1.1.2.3 2009/11/25 06:25:34 Exp $
 */
...
#define ctf_detach(ci)		((ci)->fn.detach(ci))
#define ctf_forward(ci, p)	((ci)->fn.forward(ci, p))
#define ctf_isenabled(ci, d)	((ci)->fn.isenabled(ci, d))
#define ctf_enable(ci, d, e)	((ci)->fn.enable(ci, d, e))
#define ctf_brc_add(ci, b)	((ci)->fn.brc_add(ci, b))
#define ctf_brc_delete(ci, e)	((ci)->fn.brc_delete(ci, e))
#define ctf_brc_update(ci, b)	((ci)->fn.brc_update(ci, b))
#define ctf_brc_lkup(ci, e)	((ci)->fn.brc_lkup(ci, e))
#define ctf_ipc_add(ci, i)	((ci)->fn.ipc_add(ci, i))
#define ctf_dump(ci, b)		((ci)->fn.dump(ci, b))
#define ctf_ipc_delete(ci, sip, dip, p, sp, dp)	\
	((ci)->fn.ipc_delete(ci, sip, dip, p, sp, dp))
#define ctf_ipc_lkup(ci, sip, dip, p, sp, dp)	\
	((ci)->fn.ipc_lkup(ci, sip, dip, p, sp, dp))
#define ctf_dev_register(ci, d)		((ci)->fn.dev_register(ci, d))
#define ctf_dev_unregister(ci, d)	((ci)->fn.dev_unregister(ci, d))
...
typedef int32 (*ctf_dev_register_t)(ctf_t *ci, void *dev);
...
extern ctf_t *ctf_attach(osl_t *osh, uint8 *name, uint32 *msg_level);
