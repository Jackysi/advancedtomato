 ...
 *
 * $Id: bcmsrom.c,v 1.166.2.103 2010/01/06 01:06:25 Exp $
 */
...
static char BCMNMIATTACHDATA(vstr_elna2g)[] = "elna2g=0x%x";
static char BCMNMIATTACHDATA(vstr_elna5g)[] = "elna5g=0x%x";
