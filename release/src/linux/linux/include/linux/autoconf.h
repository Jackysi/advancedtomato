...
#define CONFIG_CMDLINE "root=/dev/mtdblock2 rootfstype=squashfs,ext3 noinitrd init=/linuxrc console=ttyS0,115200"
#define CONFIG_PCI 1
...
#define CONFIG_IP_NF_TARGET_TARPIT_MODULE 1
...
#define CONFIG_GPIO_RTC_MODULE 1
#undef  CONFIG_DTLK
#undef  CONFIG_R3964
...
#undef  CONFIG_BLUEZ_HIDP
#define CONFIG_BLUEZ_HIDP_MODULE 1
