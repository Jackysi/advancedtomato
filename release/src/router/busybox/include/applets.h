...
USE_FLOCK(APPLET(flock, _BB_DIR_USR_BIN, _BB_SUID_NEVER))
...
USE_LSPCI(APPLET(lspci, _BB_DIR_SBIN, _BB_SUID_NEVER))
USE_LSUSB(APPLET(lsusb, _BB_DIR_SBIN, _BB_SUID_NEVER))
