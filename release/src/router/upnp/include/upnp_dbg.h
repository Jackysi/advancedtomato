...
#define	UPNP_MAPPING(args)					cprintf args
#define	UPNP_ERROR(args)					cprintf args
#define	UPNP_TRACE(args)					cprintf args
#define	UPNP_PRHDRS(i, s, h, p, n, l)
#define	UPNP_PRPKT(m, b, n)
#define	UPNP_INFORM(args)					cprintf args
#define UPNP_TRACE_ACTION(svc, ac) 
#define	UPNP_HTTP(args)						cprintf args
#define	UPNP_SOCKET(args) 					cprintf args
