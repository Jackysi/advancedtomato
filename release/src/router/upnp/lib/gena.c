...
/*  
    ...
    optval.l_onoff = 1;
    optval.l_linger = 0;
    setsockopt(fd, SOL_SOCKET, SO_LINGER, &optval, sizeof (optval));	// sr>fd -- zzz
*/	// removed - zzz
    ...
    if (connect_timeout(fd, (struct sockaddr *) &sr->addr, sizeof(sr->addr), 3) == -1) {
...
static void gena_connection_handler(caction_t flag, struct gena_connection *gc, PService psvc)
{
	...
	// 4309
	/* modify by zg 2006.09.22
	 * fix cdrouter3.3 item 209\210\211(cdrouter_upnp_200\cdrouter_upnp_201\cdrouter_upnp_202) bug
	 */
	if (line == NULL || !( IMATCH_PREFIX(line, "HTTP/1.1 200 OK")||IMATCH_PREFIX(line, "HTTP/1.0 200 OK") )) {
	/* end by zg 2006.09.22
	 * fix cdrouter3.3 item 209\210\211(cdrouter_upnp_200\cdrouter_upnp_201\cdrouter_upnp_202) bug
	 */
...
void update_all_subscriptions(PService psvc)
{
	...
	// 43011: add by zg 2006.11.21 for cdrouter v3.3 item 214(cdrouter_upnp_210) bug
	reap_service_subscriptions(psvc, 0);
