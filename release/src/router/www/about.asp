	...
	<div class="box box-fluid">
		<div class="content">
			...
			<form action="https://www.paypal.com/cgi-bin/webscr" method="post">
				...
				<span style="color: red;"><br /><br />Note: These donations go directly to original Tomato developer. If you wish to donate towards AdvancedTomato check <a href="http://advancedtomato.com/donate/" target="_blank">http://advancedtomato.com/donate/</a></span>
			</form>
		</div>
	</div>
</content>