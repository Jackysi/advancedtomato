...
function verifyFields(focused, quiet)
{
	...
	E('_f_mmc_exec_postumount').disabled = b;
...
function save()
{
	...
	fom.mmc_exec_postumount.value = fom.f_mmc_exec_postumount.value;
...
<input type='hidden' name='mmc_exec_postumount'>
...
createFieldTable('', [
	...
	{ title: 'Execute after umount', indent: 2, name: 'f_mmc_exec_postumount', type: 'text', maxlen: 128, size: 34, value: nvram.mmc_exec_postumount },
