...
createFieldTable('', [
	...
	{ title: '<a href="http://www.thekelleys.org.uk/dnsmasq/docs/dnsmasq-man.html" target="_new">Dnsmasq</a><br>Custom configuration', name: 'dnsmasq_custom', type: 'textarea', value: nvram.dnsmasq_custom }
]);
</script>
