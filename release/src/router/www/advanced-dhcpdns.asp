...
//	<% nvram("dnsmasq_q4,dnsmasq_q6,dnsmasq_qr,ipv6_radvd,dhcpd_dmdns,dns_addget,dhcpd_gwmode,dns_intcpt,dhcpd_slt,dhcpc_minpkt,dnsmasq_custom,dnsmasq_norw,dhcpd_lmax,dhcpc_custom,dns_norebind,dhcpd_static_only"); %>
...
function save()
{
	...
	fom.dnsmasq_q4.value = E('_f_dnsmasq_q4').checked ? '1' : '0';
	fom.dnsmasq_q6.value = E('_f_dnsmasq_q6').checked ? '1' : '0';
	fom.dnsmasq_qr.value = E('_f_dnsmasq_qr').checked ? '1' : '0';
...
<input type='hidden' name='dnsmasq_q4'>
<input type='hidden' name='dnsmasq_q6'>
<input type='hidden' name='dnsmasq_qr'>
...
createFieldTable('', [
	...
	{ title: 'Mute dhcpv4 logging', name: 'f_dnsmasq_q4', type: 'checkbox', value: nvram.dnsmasq_q4 == '1' },
	{ title: 'Mute dhcpv6 logging', name: 'f_dnsmasq_q6', type: 'checkbox', value: nvram.dnsmasq_q6 == '1' },
	{ title: 'Mute RA logging', name: 'f_dnsmasq_qr', type: 'checkbox', value: nvram.dnsmasq_qr == '1' },
