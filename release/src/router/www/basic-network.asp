...
lg.setup = function() {
	...
	this.headerSet(['<% translate("Bridge"); %>', '<% translate("STP"); %>', '<% translate("IP Address"); %>', '<% translate("Netmask"); %>', '<% translate("DHCP"); %>', '<% translate("IP Range"); %> <i>(<% translate("first/last"); %>)</i>', '<% translate("Lease Time"); %> <i>(<% translate("mins"); %>)</i>']);
