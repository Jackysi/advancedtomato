...
/* LINUX26-END */
	...
	{ title: 'APN', name: 'modem_apn', type: 'text', maxlen: 25, size: 32, suffix: ' <small>(if empty, AT+CGDCONT will not be sent)</small>', value: nvram.modem_apn },
	...
	{ title: 'Check Connection Every', name: 'modem_watchdog', type: 'text', maxlen: 6, size: 8, value: nvram.modem_watchdog, suffix: ' <small>minutes (range: 0 - 30, default: 2, set 0 to disable)</small>' },
	{ title: 'MTU', multi: [
