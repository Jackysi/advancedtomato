...
//	<% nvram("lan_ipaddr,lan_netmask,dhcpd_static,dhcpd_startip,dhcpd_static_only,arpbind_static"); %>
...
sg.verifyFields = function(row, quiet) {
	...
	if (!v_hostname(f[4], quiet, 4)) return 0;
...
sg.setup = function() {
	...
	this.headerSet(['MAC Address', 'Bound to', 'IP Address', 'Hostname' ]);
