...
function ViewPing()
{
	self.open('Ping.asp','PingTable','alwaysRaised,resizable,scrollbars,width=540,height=500').focus();
}
function ViewTraceroute()
{
	self.open('Traceroute.asp','TracerouteTable','alwaysRaised,resizable,scrollbars,width=600,height=450').focus();
}
</SCRIPT>
</HEAD>
...
<TABLE height=77 cellSpacing=0 cellPadding=0 width=809 bgColor=black border=0>
  ...
  <TR>
    <TD 
    style="FONT-WEIGHT: normal; FONT-SIZE: 10pt; COLOR: black; FONT-STYLE: normal; FONT-FAMILY: Arial, Helvetica, sans-serif; FONT-VARIANT: normal" borderColor=#000000 align=middle width=163 height=49>
      <H3 style="MARGIN-TOP: 1px; MARGIN-BOTTOM: 1px"><FONT style="FONT-SIZE: 15pt" face=Arial 
    ...
    vAlign=center borderColor=#000000 width=646 bgColor=#000000 height=49>
      <TABLE style="FONT-WEIGHT: normal; FONT-SIZE: 10pt; COLOR: black; FONT-STYLE: normal; FONT-FAMILY: Arial, Helvetica, sans-serif; BORDER-COLLAPSE: collapse; FONT-VARIANT: normal" height=33 cellSpacing=0 cellPadding=0 bgColor=#6666cc border=0>
        ...
        <TR>
          ...
          <TD borderColor=#000000 borderColorLight=#000000 align=middle width=109 bgColor=#000000 borderColorDark=#000000 height=12 rowSpan=2><FONT color=#ffffff><SPAN 
...
-->
              ...
              <TR>
                ...
                <TD align=middle bgColor=#6666cc height=20>
                  <P style="MARGIN-BOTTOM: 4px"><FONT style="FONT-WEIGHT: 700" color=#ffffff>
                       <script>Capture(bmenu.admin)</script>&nbsp;&nbsp;&nbsp;&nbsp;</FONT></P></TD>
                <TD align=middle bgColor=#000000 height=20>
                  <P style="MARGIN-BOTTOM: 4px"><FONT style="FONT-WEIGHT: 700" color=#ffffff>
                  ...
                  <TABLE borderColor=black height=21 cellSpacing=0 cellPadding=0 width=643>
                    <TBODY>
                     <TR align=left>
                      ...
                      <!-- TD width=75 -->
                      <script>document.write("<TD width=" + man_width.w6 + ">")</script> 
                      <FONT style="COLOR: white"><script>Capture(adtopmenu.diag)</script></FONT></TD>
    ...
    <TD width=809 colSpan=2>
      <TABLE cellSpacing=0 cellPadding=0 border=0>
        ...
        <TR>
          ...
          <TD width=454 bgColor=#6666cc>&nbsp;</TD>
