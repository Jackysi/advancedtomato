                  ...
                  <TABLE borderColor=black height=21 cellSpacing=0 cellPadding=0 width=643>
                    <TBODY>
                     <TR align=left>
                      ...
                      <!-- TD width=95 -->
                      <script>document.write("<TD width=" + man_width.w8 + ">")</script>
                      <FONT style="COLOR: white"><script>Capture(adtopmenu.facdef)</script></FONT></TD>
  ...
  <TR>
    <TD width=633>
      <TABLE height=100% cellSpacing=0 cellPadding=0 border=0>
        <TBODY>
        <TR>
          <TD align=right width=156 bgColor=#000000 colSpan=3 height=25><B><FONT style="FONT-SIZE: 9pt" face=Arial color=#ffffff><script>Capture(adtopmenu.facdef)</script></FONT></B></TD>
...
<b><a target="_blank" href="help/HDefault.asp"><script>Capture(share.more)</script></a></b>      
          </span></font></TD>
...
<script>document.write("<input type=button name=cancel_button" + " value=\"" + sbutton.cancel + "\" onClick=window.location.replace(\"Factory_Defaults.asp\")>");</script>&nbsp;&nbsp;
