                ...
                <TD width=643 bgColor=#6666cc colSpan=7 height=21>
                  <TABLE borderColor=black height=21 cellSpacing=0 cellPadding=0 width=643>
                    ...
                    <TR align=left>
                      ...
                      <!-- TD width=100 -->
                      <script>document.write("<TD width=" + sta_width.w4 + ">")</script>
                      <FONT style="COLOR: white"><script>Capture(statopmenu.localnet)</script></FONT></TD>
...
<b><a target="_blank" href="help/HStatus.asp#lan"><script>Capture(share.more)</script></a></b></span></font></TD></TR>
...
<script>document.write("<INPUT onclick=window.location.replace(\'Status_Lan.asp\') type=button name=refresh_button value=\"" + sbutton.refresh + "\">");</script>&nbsp;&nbsp;
