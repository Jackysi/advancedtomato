...
<div id='bwlimit'>
	...
	<div class='section'>
		<script type='text/javascript'>
			...
			{ title: 'Max Download Bandwidth <br><small>(same as used in QOS)', name: 'qos_ibw', type: 'text', maxlen: 6, size: 8, suffix: ' <small>kbit/s</small>', value: nvram.qos_ibw },
			{ title: 'Max Upload Bandwidth <br><small>(same as used in QOS)', name: 'qos_obw', type: 'text', maxlen: 6, size: 8, suffix: ' <small>kbit/s</small>', value: nvram.qos_obw }
			]);
		</script>
		<br>
