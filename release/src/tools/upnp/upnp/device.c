...
void device_xml(PDevice pdev, UFILE *up)
{
	...
	/*Zhijian 2007-07-17 Add to fixed the bug that UPnP icon cannot be displayed on my neighbourhood of network*/
	...
	/*Zhijian 2007-07-17 Add to fixed the bug that UPnP icon cannot be displayed on my neighbourhood of network*/
    uprintf(up, "<presentationURL>http://%s:%d/index.asp</presentationURL>\r\n", nvram_safe_get("lan_ipaddr"), 80);
