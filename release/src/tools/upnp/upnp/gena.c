...
void update_all_subscriptions(PService psvc)
{
    PSubscription psub, nextsub;
    UFILE *ubody;
    time_t now;//add by zg 2006.11.21 for cdrouter v3.3 item 214(cdrouter_upnp_210) bug 
    ...
    /********add by zg 2006.11.21 for cdrouter v3.3 item 214(cdrouter_upnp_210) bug********/
    now = time(NULL);
    reap_service_subscriptions(psvc, now);
    /********end by zg 2006.11.21 for cdrouter v3.3 item 214(cdrouter_upnp_210) bug********/
